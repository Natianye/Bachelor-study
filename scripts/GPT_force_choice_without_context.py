...
for idx, row in df.iterrows():
    ...
    prompt = f"""You will read each time two questions. Each question may have been written by either a human or an LLM.
Which question is more 'human-like' or "natural"? Please answer "A" or "B" and give the reason for your choice.
...
results_df.to_csv('GPT_humanlike_judgment_without_context.csv', index=False)